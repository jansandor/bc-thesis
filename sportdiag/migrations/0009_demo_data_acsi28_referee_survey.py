# Generated by Django 3.2.8 on 2022-05-08 08:53
...
@transaction.atomic
def add_acsi28_referee_survey(apps, schema_editor):
    Survey = apps.get_model(app_name, 'Survey')
    survey = Survey.objects.create(
        name=survey_name,
        description="""The Athletics Coping Skills Inventory – 28 (Smith et al., 1995) 
        je standardizovaná americká metoda, která se používá ke zjišťování úrovně 
        copingových dovedností sportovců. Americká verze se sestává z 28 otázek, 
        které jsou koncipovány do sedmi konkrétních oblastí (škál). 
        ...
        Stanovení cílů a Mentální přípravu, koncentraci, 
        Důvěru v sebe sama a Dosažení motivace, Schopnost akceptovat konstruktivní kritiku 
        a Osvobození se od strachu. Dotazník byl adaptován do češtiny pro populaci 
        rozhodčích. V této verzi obsahuje 27 otázek.""",
        instructions="""Pozorně si prosím přečtěte každé tvrzení a vyberte jednu odpověď, 
        se kterou se nejvíce ztotožňujete. V dotazníku nejsou žádné správné nebo špatné 
        odpovědi. Prosím, vyberte, jak často provádíte zmiňovanou činnost při vašem výkonu.""",
        is_published=True,
        type=_Survey.ACSI28_REFEREE,
    )
    # add acsi28 referee survey categories
    ...
    questions = [
        ...
        Question(text="Rozhodcovská úroveň",
                 number=0,
                 order=1,
                 required=True,
        ...
        Question(text="Zůstávám pozitivně naladěný a nadšený během zápasu, bez ohledu na to, jak špatně se vyvíjí.",
                 number=5,
                 order=6,
                 required=True,
        ...
        Question(text="Udržuji emoce pod kontrolou bez ohledu na to, jak se věci vyvíjí.",
                 ...
                 category=categories[0]),
        #
        Question(text="Když mi delegát nebo mentor řekne, kde dělám chybu, mám tendenci si to brát osobně.",
                 number=3,
                 order=4,
                 required=True,
                 type=_Question.RADIO,
        ...
        Question(text="Když mě delegát nebo mentor kritizují, spíše mě to rozčílí, než by mi to pomohlo.",
                 number=10,
                 order=11,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 scores=scores_desc,
                 category=categories[1]),
        Question(text="Když mě delegát kritizuje, příště napravím chybu bez toho, že bych se rozčílil.",
                 number=15,
                 order=16,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 category=categories[1]),
        Question(
            text="Zlepšuji své dovednosti tím, že pozorně poslouchám rady a instrukce od zkušenějšího rozhodčího nebo mentora.",
            number=27,
            order=28,
            required=True,
            type=_Question.RADIO,
            ...
            category=categories[1]),
        #
        Question(text="Když řídím utkání, dokážu se soustředit a eliminovat rušivé vlivy.",
                 number=4,
                 order=5,
                 required=True,
                 type=_Question.RADIO,
        ...
        Question(
            ...
            scores=scores_asc,
            category=categories[2]),
        Question(text="S neočekávanými situacemi ve svém sportu se vyrovnávám velmi dobře.",
                 number=16,
                 order=17,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 scores=scores_asc,
                 category=categories[2]),
        Question(text="Je pro mě jednoduché zaměřit pozornost a koncentrovat se na jednu věc nebo osobu.",
                 number=25,
                 order=26,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 category=categories[2]),
        #
        Question(text="Dokážu zúročit svůj talent a dovednosti.",
                 number=2,
                 order=3,
                 required=True,
                 type=_Question.RADIO,
        ...
        Question(text="Věřím si, že odřídím (odpískám) dobrý zápas.",
                 number=9,
                 order=10,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 scores=scores_asc,
                 category=categories[3]),
        Question(text="Nemusí na mě nikdo tlačit, abych podával výkon na hranici svých možností, dávám tomu 100 %.",
                 number=14,
                 order=15,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 scores=scores_asc,
                 category=categories[3]),
        Question(text="Když nedosáhnu svých cílů, přinutí mě to k ještě většímu úsilí.",
                 number=26,
                 order=27,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 category=categories[3]),
        #
        Question(text="Denně nebo týdně si stanovuji konkrétní cíle, které mi řídí moji činnosti.",
                 number=1,
                 order=2,
                 required=True,
                 type=_Question.RADIO,
        ...
        Question(text="Často plánuji, jak dosáhnout svých cílů.",
                 number=8,
                 order=9,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 scores=scores_asc,
                 category=categories[4]),
        Question(text="Pro každý trénink si stanovuji osobní výkonnostní cíle.",
                 number=13,
                 order=14,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 scores=scores_asc,
                 category=categories[4]),
        Question(text="Mám vypracovaný vlastní strategický plán v hlavě dlouho před tím, než zápas začne.",
                 number=20,
                 order=21,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 category=categories[4]),
        #
        Question(text="Rozhoduji lépe pod tlakem, protože mám jasnou mysl.",
                 number=6,
                 order=7,
                 required=True,
                 type=_Question.RADIO,
        ...
        Question(text="Čím více jsem podtlakem během zápasu, tím víc si to užívám.",
                 number=18,
                 order=19,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 scores=scores_asc,
                 category=categories[5]),
        Question(text="Zátěžové situace jsou pro mě výzvou a vítám je.",
                 number=22,
                 order=23,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 scores=scores_asc,
                 category=categories[5]),
        Question(text="Dělám méně chyb, když jsem pod tlakem, protože se lépe koncentruji.",
                 number=28,
                 order=29,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 category=categories[5]),
        #
        Question(text="Dost mi záleží na tom, co si ostatní myslí o mém výkonu.",
                 number=7,
                 order=8,
                 required=True,
                 type=_Question.RADIO,
        ...
        Question(text="Vyvíjím na sebe velký tlak tím, jak moc mi záleží na mém výkonu.",
                 number=12,
                 order=13,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 scores=scores_desc,
                 category=categories[6]),
        Question(text="Během zápasu se bojím, abych neudělal špatné rozhodnutí, a mám strach z neúspěchu.",
                 number=19,
                 order=20,
                 required=True,
                 type=_Question.RADIO,
                 ...
                 scores=scores_desc,
                 category=categories[6]),
        Question(text="Myslím a představuji si, co se stane, když udělám chybu nebo neuspěji.",
                 number=23,
                 order=24,
                 required=True,
                 type=_Question.RADIO,
...
@transaction.atomic
def revert_acsi28_referee_survey(apps, schema_editor):
    Survey = apps.get_model(app_name, 'Survey')
...
class Migration(migrations.Migration):
    dependencies = [
        ('sportdiag', '0008_demo_data_acsi28_athletes_survey'),
    ]

    operations = [
        migrations.RunPython(add_acsi28_referee_survey, reverse_code=revert_acsi28_referee_survey),
    ]
