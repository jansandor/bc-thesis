...
from .forms import (
    ClientUserCreationForm,
    PsychologistUserCreationForm,
    ResearcherUserCreationForm,
    ClientChangeForm,
    PsychologistChangeForm,
    ResearcherChangeForm,
)
...
class ClientSignUpView(CreateView):
    ...
    success_url = reverse_lazy("client_signup_confirm")
    ...
    account_activation_email_html = (
        "accounts/registration/emails/account_activation_email.html"
    )
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            message = render_to_string(
                self.account_activation_email_html,
                {
...
class PsychologistSignUpView(CreateView):
    ...
    success_url = reverse_lazy("psychologist_signup_confirm")
...
class ClientSignUpConfirmView(TemplateView):
    template_name = "accounts/registration/client_signup_confirm.html"


class PsychologistSignUpConfirmView(TemplateView):
    template_name = "accounts/registration/psychologist_signup_confirm.html"


def activate(request, uidb64, token):
    activation_confirm_template_name = (
        "accounts/registration/account_activation_confirm.html"
    )
    activation_link_used_template_name = (
        "accounts/registration/account_activation_invalid_link.html"
    )
    new_psychologist_registration_email_html_template = (
        "accounts/registration/emails/new_psychologist_registration_email.html"
    )
    new_client_email_html_template = (
        "accounts/registration/emails/new_client_email.html"
    )
    ...
    if (
        user is not None
        and account_activation_token_generator.check_token(user, token)
...
class ResearcherCreateView(
    LoginRequiredMixin, StaffResearcherRequiredMixin, CreateView
):
    model = get_user_model()
    ...
    account_activation_token_generator = default_token_generator
    account_activation_email_html = (
        "accounts/registration/emails/researcher_account_activation_email.html"
    )
